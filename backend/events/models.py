...
class Coordinators(AbstractUser):
    ...
    branch = models.CharField( max_length = 244, choices=BRANCH_CHOICE, blank=True)
...
class Events(TimeStamped):
    ...
    co_ord = models.ManyToManyField(Coordinators,   verbose_name= "Co-ordinators", blank=True)
